...
public class LockOnIndicatorView : UIView
{
    ...
    private void FollowWorld()
    {
        ...
        Camera cam = overlayCam != null ? overlayCam : Camera.main;
        if (cam == null) return;
    ...
    private void EnsureWorldFollowSetup()
    {
        ...
        canvas.worldCamera = overlayCam != null ? overlayCam : Camera.main;
    ...
    private void EnsureOverlayCamera()
    {
        ...
        if (data != null)
        {
            ...
            {
                Camera stacked = data.cameraStack[i];
    ...
    private void ConfigureOverlayCamera(Camera cam, Camera main)
    {
