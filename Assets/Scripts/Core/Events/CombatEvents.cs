...
public static partial class CombatEvents
{
    ...
    /// <summary>
    /// 危字提示时触发。参数：危字类型（突刺/扫击/投技）
    /// </summary>
    public static event Action<AttackType> OnDangerWarning;
    ...
    /// 触发危字提示事件
    /// </summary>
    /// <param name="type">危字类型</param>
    public static void RaiseDangerWarning(AttackType type) => OnDangerWarning?.Invoke(type);
