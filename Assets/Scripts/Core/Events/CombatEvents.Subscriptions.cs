...
public static partial class CombatEvents
{
    ...
    /// 订阅危字提示事件
    /// </summary>
    /// <param name="callback">回调函数，参数为危字类型</param>
    public static void SubscribeOnDangerWarning(Action<AttackType> callback) => OnDangerWarning += callback;
    ...
    /// </summary>
    /// <param name="callback">要移除的回调函数</param>
    public static void UnsubscribeOnDangerWarning(Action<AttackType> callback) => OnDangerWarning -= callback;
