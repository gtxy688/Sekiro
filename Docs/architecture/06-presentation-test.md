...
| 15c | 绕到玩家侧面再喝 | 字仍正对相机 |
| 15d | 没药时按 E | 不出现治字 |
| 15e | Boss 放危字 | 仍只在 Boss 头顶出红「危」，玩家头上不出「治」 |
| 15f | 喝药中被打断 | 治字继续播完淡出，不跟受击一起立刻消失 |
| 16 | 玩家死亡一次 | 左下角回生节点变暗（用了） |
| 16b | 有复活次数时倒地 | 屏幕压暗，居中暗金面板：「回生」+「按攻击键复活」；不是粉红大字 |
| 16c | 按攻击键复活 | 提示淡出，能继续打 |
| 16d | 处决 Boss 最后一命 | 暗金面板：「胜利」+「击败 苇名弦一郎」+「再来一局」按钮（默认选中，亮金底） |
| 16e | 胜利后推摇杆 / WASD | 角色不走，停在待机 |
| 16f | 点「再来一局」或手柄确认 | 重载当前场景，能重新打 |
| 16g | 进入战斗 | 底栏正中架势条上方出台词「我上了」，同时播 `Voices/160000`（不在左下血条上）；中文不缺字、不警告缺 glyph |
| 16h | 玩家倒地（还能回生） | 台词「我，一定会守护苇名」+ `160400`；回生面板仍在 |
| 16i | 按攻击键复活 | 先「是龙胤的力量吗。」（160200），播完再接「那么,无论多少次杀死你为止。」（160201） |
