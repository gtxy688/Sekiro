...
| # | 操作 | 预期 |
|---|------|------|
| 10 | 把玩家 HP 打到 0 | 触发 OnReviveAvailable（画面开始变暗）；倒完才 OnReviveChoiceReady |
| 10b | 变暗期间按攻击/防御 | 不复活、不放弃 |
| 11 | 选项出现后点「起死回生」或按攻击键 | 回满血 + 架势清零，ReviveRemaining 减 1 |
| 11b | 点「就此死去」或按防御键 | 进真死，不再回生 |
